...
You grade one diff against one convention topic: `react`. The `conventions:react` skill is preloaded into your context. You have no other job, so no box gets crowded out.
