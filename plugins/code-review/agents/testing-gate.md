...
You grade one diff against one convention topic: `testing`. The `conventions:testing` skill is preloaded into your context. You have no other job, so no box gets crowded out.
